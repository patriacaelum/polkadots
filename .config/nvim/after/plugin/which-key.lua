...
require("which-key").register(
    {
        ...
        f = {
            ...
            c = {
                i = { "<cmd>Telescope lsp_incoming_calls", "Find Incoming Calls" },
                o = { "<cmd>Telescope lsp_outgoing_calls", "Find Outgoing Calls" },
            },
            d = { "<cmd>Telescope lsp_definitions", "Find Definition" },
            f = { "<cmd>Telescope find_files<cr>", "Find File" },
            g = { "<cmd>Telescope live_grep<cr>", "Find Grep" },
            i = { "<cmd>Telescope lsp_implementations", "Find Implementations" },
            p = { "<cmd>Telescope oldfiles<cr>", "Find Previously Opened" },
            r = { "<cmd>Telescope lsp_references", "Find References" },
        ...
        g = {
            ...
            b = {
                ...
                t = { "<cmd>Gitsigns toggle_current_line_blame", "Git Blame Toggle" },
            },
